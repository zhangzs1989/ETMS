<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JuneitrainInquiry.aspx.cs" Inherits="zzs.sddj.Webapp.DepartmentUI.WebForm1"%>
...
<body font:"14px/21px","Lucida Sans", "Lucida Grande", "Lucida Sans Unicode", sans-serif;>
    <form class="contact_form" action="JuneitrainInquiry.aspx" method="post" name="contact_form" enctype="multipart/form-data" runat="server">
        ...
        <li>
        <label for="name">培训人员:</label>
        <asp:Button ID="Button4" runat="server" Text="选择参训人员" Height="33px" Width="102px" OnClick="Button4_Click" />
        </li>
        <li>
        <label for="message">其他培训人员及所在单位：</label>
        <textarea id="qitarenyuan" name="qitarenyuan" runat="server" class="auto-style3" placeholder="其他人员为局机关，驻济各单位，各直属台站、各代管台站以外参训人员"></textarea>
        <span class="form_hint"></span>
        </li>
	    <li>
        <label for="name">培 训 年 度:</label>
        <input type="text" id="peixunniandu" name="peixunniandu"  runat="server" maxlength="4" onkeyup="this.value=this.value.replace(/\D/g,'')" onfocus="javascript:if(this.value=='请输入内容')this.value='';" onblur="checkniandu()"/>
        ...
        <input type="text" id="peixunname" name="peixunname"  runat="server" onblur="checkname()"/>
        <span class="form_hint"></span>
	    </li>
	    <li>
        <label for="email">培 训 地 点   :</label>
        <input type="text" id="peixundidian" name="peixundidian" runat="server" onblur="checkdidian()"/>
        <span class="form_hint"></span>
	    </li>
        <li>
        <label for="email">培 训 时 间   :</label>
        <input type="text" id="peixuntime" name="peixuntime"  runat="server" onblur="checktime()" />
        <span class="form_hint"></span>
	    </li>
	    <li>
        <label for="name">培 训 学 时:</label>
        <input type="text" id="peixunxueshi" name="peixunxueshi" onblur="checkxueshi()"  runat="server" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" />
        ...
        <textarea id="jnbeizhu" name="jnbeizhu" runat="server"  class="auto-style1"></textarea>
	    </li>
	...
	<li>
        ...
        <asp:Button class="submit" type="submit" OnClick="Button1_Click" Text="  提交信息" 
