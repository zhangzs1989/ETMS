<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JwTrainTj.aspx.cs" Inherits="zzs.sddj.Webapp.DepartmentUI.JwTrainTj" %>
...
<body font:"14px/21px","Lucida Sans", "Lucida Grande", "Lucida Sans Unicode", sans-serif;>
	<form class="contact_form" action="JwTrainTj.aspx" method="post" name="contact_form" enctype="multipart/form-data" runat="server">
	<ul>
    <li>
         <h2>局外参训提交</h2>
    ...
    <li>
        <label for="website">培训年度:</label>
    <input type="text" name="peixunniandu" onkeyup="this.value=this.value.replace(/\D/g,'')" required/>
    <span class="form_hint">格式：2017</span>
    </li>
	<li>
    <label for="website">培训起止时间:</label>
    <input type="text" name="peixunshijian" required/>
    <span class="form_hint">格式：0101-0120</span>
	</li>
	<li>
        <label for="name">培训学时:</label>
        <input type="text" name="peixunxueshi" onkeyup="this.value=this.value.replace(/\D/g,'')" required/>
