...
{
    public partial class DepartmentNewnotice : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    sb.AppendFormat("<tr><td>{0}</td><td>{1}</td><td>{2}</td><td>{3}</td><td><a href='DepartmentShowNoticeDetail.aspx?id={4}'>查看详细</a></td></tr>", iicount, notice.Title, notice.Regtime1, notice.Issuer, notice.Id);
                    iicount++;
                }
                StrHtml = sb.ToString();
