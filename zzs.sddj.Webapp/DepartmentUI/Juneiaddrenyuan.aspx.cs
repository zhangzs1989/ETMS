...
{
    public partial class Juneiaddrenyuan : System.Web.UI.Page
    {
        private readonly string ConnString = @"database=mydb;uid=sa;pwd=zhangzs";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                dt = new DataTable();
                GetMenuToDataTable("select * from test", dt);
                BindTree(dt, null, "0");
