<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowjnDetail.aspx.cs" Inherits="zzs.sddj.Webapp.UserUI.ShowjnDetail" %>
...
<body>
    ...
    <table class="auto-style4">
            ...
            <tr><td>培 训 备 注   :  </td><td colspan="2"><textarea id="peixunbeizhu" name="peixunbeizhu" runat="server" disabled="disabled" placeholder="此项内容必填，某些浏览器可能不显示*号" class="auto-style7"></textarea></td></tr>
            <tr><td colspan="2">
