<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserNewnotice.aspx.cs" Inherits="zzs.sddj.Webapp.UserUI.UserNewnotice" %>
...
<body>
    ...
    <li><a href="UserNewnotice.aspx">最新通知</a></li>
    </ul>
    </div>
   ...
   <div class="pages">
                   ...
                   <a href="UserNewnotice.aspx?pageindex=1"> 首页</a>  | <a href="UserNewnotice.aspx?pageindex=<%=Pageindex-1 %>>">前页</a>  | 
                    

                      <a href="UserNewnotice.aspx?pageindex=<%=Pageindex+1 %>">后页</a> |  <a href="UserNewnotice.aspx?pageindex=<%=Pagecounts %>"> 尾页 </a>  | 页次：<%=Pageindex %>/<%=Pagecounts %>页 
                    <hr />
