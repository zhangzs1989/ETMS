<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowNoticeDetail.aspx.cs" Inherits="zzs.sddj.Webapp.AdminUI.ShowNoticeDetail" %>
...
<body>
    <form id="form1" runat="server" action="ShowNoticeDetail.aspx">
     <FTB:FreeTextBox ID="ft3" runat="server" Height="500px" Width="1000px"></FTB:FreeTextBox>
