<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddJwTrain.aspx.cs" Inherits="zzs.sddj.Webapp.AdminUI.AddJwTrain" %>
...
<body font:"14px/21px","Lucida Sans", "Lucida Grande", "Lucida Sans Unicode", sans-serif;>
    ...
    <li>
        ...
        <input type="text" name="peixunren" required/>
    </li>
	...
	<li>
        ...
        <option class="fangshifontcolor">省委、省政府组织的培训
        <option class="fangshifontcolor">中央组织的培训 
    ...
    <input type="text" name="peixunniandu" maxlength="4" onkeyup="this.value=this.value.replace(/\D/g,'')" onfocus="javascript:if(this.value=='请输入内容')this.value='';" required/>
    <span class="form_hint"></span>
	</li>
	<li>
	...
	<li>
        ...
        <input type="text" name="peixunxueshi" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" required/>
    ...
    <textarea name="peixunneirong" required placeholder="此项内容必填，某些浏览器可能不显示*号" class="auto-style1"></textarea>
	</li>
    <%--<li>
