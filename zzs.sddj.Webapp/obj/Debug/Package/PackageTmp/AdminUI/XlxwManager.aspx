<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XlxwManager.aspx.cs" Inherits="zzs.sddj.Webapp.AdminUI.XlxwManager" %>
...
<body>
    ...
    <span>位置：</span>
    <ul class="placeul">
    <li><a href="#">学历学位升级管理</a></li>
    <li><a href="#">学历学位管理</a></li>
    </ul>
    </div>
        <%--<table>
    ...
    <div class="rightinfo">        
        ...
        <th style="text-align:center">就读地点</th>
   ...
   <div class="pages">
                   ...
                   <a href="XlxwManager.aspx?pageindex=1"> 首页</a>  | <a href="XlxwManager.aspx?pageindex=<%=Pageindex-1 %>">  前页 </a>  | 
                    

                      <a href="XlxwManager.aspx?pageindex=<%=Pageindex+1 %>">后页</a> |  <a href="XlxwManager.aspx?pageindex=<%=Pagecounts %>"> 尾页 </a>   | 页次 <%=Pageindex %>/<%=Pagecounts %>页
                    <hr />
