<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditDepartLogininfo.aspx.cs" Inherits="zzs.sddj.Webapp.AdminUI.EditDepartLogininfo" %>
...
<body>
    ...
    <table class="auto-style4">
        ...
        <tr><td colspan="2"><asp:Button ID="Button1" runat="server" Text="修改信息" Height="42px" Width="91px" OnClick="Button1_Click" /></td></tr>
    </table>
    </div>
    </form>
</body>
