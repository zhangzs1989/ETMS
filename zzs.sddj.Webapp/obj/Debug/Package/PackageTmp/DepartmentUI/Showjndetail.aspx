<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Showjndetail.aspx.cs" Inherits="zzs.sddj.Webapp.DepartmentUI.Showjndetail" %>
...
<body style="height: 571px">
    <form id="form1" runat="server" action="Showjndetail.aspx" method="post">
        <div class="place">
        <span>位置：</span>
        <ul class="placeul">
        <li><a href="#">通知公告</a></li>
        ...
        <div>
            ...
            <tr><td>培 训 人 员   :</td><td colspan="2"><input type="text" id="peixunrenyuan" name="peixunrenyuan"  runat="server"  class="auto-style11"/></td></tr>
            ...
            <tr><td>其 他 培 训 人 员 :  </td><td colspan="2"><textarea id="qitarenyuan" name="qitarenyuan" runat="server" placeholder="此项内容必填，某些浏览器可能不显示*号" class="auto-style7"></textarea></td></tr>
