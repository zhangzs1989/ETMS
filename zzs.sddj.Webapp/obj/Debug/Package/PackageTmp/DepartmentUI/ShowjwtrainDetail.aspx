<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowjwtrainDetail.aspx.cs" Inherits="zzs.sddj.Webapp.DepartmentUI.ShowjwtrainDetail" %>
...
<body>
    ...
    <table class="auto-style4">
            ...
            <tr><td>培 训 年 度   :</td><td colspan="2"><input type="text" id="peixunniandu" name="peixunniandu" runat="server" disabled="disabled" class="auto-style11"/></td></tr>
            <tr><td>培 训 人   :</td><td colspan="2"><input type="text" id="peixunren" name="peixunren" runat="server" disabled="disabled" class="auto-style11"/></td></tr>
            <tr><td>培 训 方 式   :</td><td colspan="2"><input type="text" id="peixunfangshi" name="peixunfangshi" runat="server" disabled="disabled" class="auto-style11"/></td></tr>
            ...
            <tr><td>培 训 承 办   :</td><td colspan="2"><input type="text" id="peixunchengban" name="peixunzhuban" runat="server" disabled="disabled" class="auto-style11"/></td></tr>
