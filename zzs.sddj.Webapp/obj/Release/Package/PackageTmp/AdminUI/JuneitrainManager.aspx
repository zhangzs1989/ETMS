<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JuneitrainManager.aspx.cs" Inherits="zzs.sddj.Webapp.AdminUI.JuneitrainManager" %>
...
&nbsp;<div class="rightinfo">
   ...
   <div class="pages">
                   ...
                   <a href="JuneitrainManager.aspx?pageindex=1"> 首页</a>  | <a href="JuneitrainManager.aspx?pageindex=<%=Pageindex-1 %>>">前页</a>  | 
                    

                      <a href="JuneitrainManager.aspx?pageindex=<%=Pageindex+1 %>">后页</a> |  <a href="JuneitrainManager.aspx?pageindex=<%=Pagecounts %>"> 尾页 </a>   | 页次 <%=Pageindex %>/<%=Pagecounts %>页 
                    <hr />
