<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JuwaitrainManager.aspx.cs" Inherits="zzs.sddj.Webapp.AdminUI.JuwaitrainManager" %>
...
&nbsp;<div class="rightinfo">
   ...
   <div class="pages">
                   ...
                   <a href="JuwaitrainManager.aspx?pageindex=1"> 首页</a>  | <a href="JuwaitrainManager.aspx?pageindex=<%=Pageindex-1 %>>">前页</a>  | 
                    

                      <a href="JuwaitrainManager.aspx?pageindex=<%=Pageindex+1 %>">后页</a> |  <a href="JuwaitrainManager.aspx?pageindex=<%=Pagecounts %>"> 尾页 </a>   | 页次 <%=Pageindex %>/<%=Pagecounts %>页 
                    <hr />
