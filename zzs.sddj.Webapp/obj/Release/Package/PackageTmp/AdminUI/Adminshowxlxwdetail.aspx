<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Adminshowxlxwdetail.aspx.cs" Inherits="zzs.sddj.Webapp.AdminUI.Adminshowxlxwdetail" %>
     ...
     <table class="auto-style4">
            ...
            <tr><td>审 批</td><td colspan="2" class="auto-style13">
                <asp:DropDownList ID="DropDownList1" runat="server" Height="22px" Width="81px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                    <asp:ListItem>主管部门：通过审批</asp:ListItem>
                    <asp:ListItem>主管部门：不通过审批</asp:ListItem>
