...
namespace zzs.sddj.Webapp.AdminUI
{
    ...
    public class AdminIndex : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string filepath = context.Request.MapPath("AdminIndex.html");
            string filecontent = File.ReadAllText(filepath);
            HttpBrowserCapabilities bc = HttpContext.Current.Request.Browser;
            string userloginame = HttpContext.Current.Request.Cookies["userloginame"].Value;
            filecontent = filecontent.Replace("$browertype", bc.Browser).Replace("$browerversion", bc.Version).Replace("$UserDomainName", GetOSVersion()).Replace("$clientip", GetIPAddress).Replace("$loginlastertime", DateTime.Now.ToLocalTime().ToString()).Replace("$admin", userloginame);
