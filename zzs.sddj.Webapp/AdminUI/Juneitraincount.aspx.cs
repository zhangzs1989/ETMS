...
{
    public partial class Juneitraincount : System.Web.UI.Page
    {
        public int Pagecounts { get; set; }
        public string StrHtml { get; set; }
        public int Pageindex { get; set; }
        public int jncount { get; set; }
        public int jnpersoncount { get; set; }
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    jncount = pagelist.Getjntraininfocounts();
                    jnpersoncount = pagelist.Getjntraininfocounts_jntrain();
                }
            }
        }
    }
