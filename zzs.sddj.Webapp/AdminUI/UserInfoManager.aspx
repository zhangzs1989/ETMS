<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserInfoManager.aspx.cs" Inherits="zzs.sddj.Webapp.AdminUI.UserInfoManager" %>
...
&nbsp;
    ...
    <table class="tablelist">
        ...
        <div class="pages">
                   ...
                   <a href="UserInfoManager.aspx?pageindex=1"> 首页</a>  |  <a href="UserInfoManager.aspx?pageindex=<%=Pageindex-1 %>"> 前页 </a>  | 
                      <a href="UserInfoManager.aspx?pageindex=<%=Pageindex+1 %>">后页</a> |  <a href="UserInfoManager.aspx?pageindex=<%=Pagecounts %>"> 尾页 </a>   | 页次 <%=Pageindex %>/<%=Pagecounts %>页 
                    <hr />
