...
{
    public partial class DownloadUsercanxun : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (issucess==1)
            {
                ...
                int wlxf = 0;
                getExcel(jwda, jnda, userloginame,wlxf);
            }
            else
            {
        ...
        protected void getExcel(DataTable dt, DataTable dt2, string username,int wlxf)
        {
            ...
            book.Write(ms);
            Response.AddHeader("Content-Disposition", string.Format("attachment; filename={0}.xls", Text1.Value.Trim() + "参训情况"));
