<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Showadminjndetail.aspx.cs" Inherits="zzs.sddj.Webapp.AdminUI.Showadminjndetail" %>
...
<body style="height: 571px">
    <form id="form1" runat="server" action="Showadminjndetail.aspx" method="post">
        <div class="place">
        <span>位置：</span>
        <ul class="placeul">
        <li><a href="#">局内培训</a></li>
        ...
        <div>
            ...
            <tr><td>其 他 人 员 :  </td><td colspan="2"><textarea id="qitarenyuan" name="qitarenyuan" runat="server" placeholder="此项内容必填，某些浏览器可能不显示*号" class="auto-style7"></textarea></td></tr>
