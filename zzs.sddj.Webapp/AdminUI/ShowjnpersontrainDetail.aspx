<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="ShowjnpersontrainDetail.aspx.cs" Inherits="zzs.sddj.Webapp.AdminUI.ShowjnpersontrainDetail" %>
...
<body style="height: 571px">
    <form id="form1" runat="server" action="ShowjnpersontrainDetail.aspx" method="post">
        <div class="place">
        <span>位置：</span>
        <ul class="placeul">
        <li><a href="#">局内培训</a></li>
