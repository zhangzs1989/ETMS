...
{
    public partial class Adminshowxlxwdetail : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            zzs.sddj.Model.Xuelixuewei xlxw = new Model.Xuelixuewei();
        ...
        {
            zzs.sddj.Model.Xuelixuewei xlxw2 = new Model.Xuelixuewei();
            Xlxwbll xlxwbll = new Xlxwbll();
            Context.Response.ContentType = "text/html";
            int id = Convert.ToInt32(Context.Request.QueryString["id"]);
            ...
            Context.Response.Redirect("AdminxlxwSP.aspx");
        }
