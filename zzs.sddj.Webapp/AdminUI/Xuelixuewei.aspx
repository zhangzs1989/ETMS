<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Xuelixuewei.aspx.cs" Inherits="zzs.sddj.Webapp.AdminUI.Xuelixuewei" %>
...
&nbsp;<div class="rightinfo">
   ...
   <div class="pages">
                   ...
                   <a href="Xuelixuewei.aspx?pageindex=1"> 首页</a>  | <a href="Xuelixuewei.aspx?pageindex=<%=Pageindex-1 %>>">前页</a>  | 
                    

                      <a href="Xuelixuewei.aspx?pageindex=<%=Pageindex+1 %>">后页</a> |  <a href="Xuelixuewei.aspx?pageindex=<%=Pagecounts %>"> 尾页 </a>   | 页次 <%=Pageindex %>/<%=Pagecounts %>页 
                    <hr />
